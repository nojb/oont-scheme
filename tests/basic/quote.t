  ...
  (apply (field 7 (global Oont!))
    (makemutable 0 (apply (field 6 (global Oont!)) "a")
      (makemutable 0 (apply (field 6 (global Oont!)) "b")
        (makemutable 0 (apply (field 6 (global Oont!)) "c")
          -4611686018427387900))))
  ...
  (apply (field 7 (global Oont!)) -4611686018427387900)
  $ ./quote2.exe
  ()
